...
local themeStyles = {
    ...
    LightTheme = {
        SchemeColor = Color3.fromRGB(0,0,0), --changed custom
        Background = Color3.fromRGB(0,0,0), --changed custom
        Header = Color3.fromRGB(0,0,0), --changed custom
        TextColor = Color3.fromRGB(0,0,0), --changed custom
        ElementColor = Color3.fromRGB(0,0,0) --changed custom
    },
    BloodTheme = {
